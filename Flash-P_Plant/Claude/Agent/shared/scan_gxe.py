...
On the FLASH-P multiplicative scale (geometric-mean activation, soft-bounded
...
GxE ~ 0 (they are log-additive). Non-zero GxE in a FLASH-P network arises from:
  (1) SATURATION of the inhibition term 2/(1 + product(inhibitors)) -- the
      product is what separates multiplicatively, but the 2/(1+x) transfer
      around it does not, so two inhibitors of the same node interact as the
      term approaches its ceiling of 2.0; and
