...
def main():
    ...
    L.append("- Interactions come from saturation of the inhibition term as it nears its "
             "ceiling of 2.0, and from genes/environments sharing downstream nodes; a "
             "clean single multiplication gives ~0. See `scan_gxe.py` header for the "
             "full rationale.")
